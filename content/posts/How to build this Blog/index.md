...
Move-Item \
  -LiteralPath 'D:\Blog\my-blog\themes\hugo-theme-stack\.git' \
  -Destination 'D:\Blog\hugo-theme-stack-git-metadata-backup'\
不使用子模块，而是把 Stack 主题源码完整纳入博客仓库。这样即使主题仓库以后消失，博客仓库仍然是完整的。
### 二
创建 .gitignore，告诉 Git 哪些文件忽略。比如下面这些\
...
执行之后，Git 会在D:\Blog\my-blog\里面创建一个隐藏的：.git\
